...
%% Try with multidim binary approach

twoDTimeSeriesOctave = zeros(2, length(sourceArray));
% destArray = [destArray(100); destArray(1:99)];
twoDTimeSeriesOctave(1, :) = sourceArray';
twoDTimeSeriesOctave(2, :) = destArray';
